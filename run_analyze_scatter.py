...
analy.save_scatter_analysis(icr=icr,fname=f"scatter_analysis{icr}_vertical",folder="scatter_analysis",exts=".txt",filelist=filelist,vh="vertical")
analy.analyze_scatter_horizontal()
analy.save_scatter_analysis(icr=icr,fname=f"scatter_analysis{icr}_horizontal",folder="scatter_analysis",exts=".txt",filelist=filelist,vh="horizontal")
print("----------- end --------------------------------")
